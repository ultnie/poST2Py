...
public class GeneratorUtil {
  ...
  public static String generateConstant(final Constant constant) {
    ...
    if (_tripleNotEquals_3) {
      ...
      _builder_2.append("timedelta(");
      String _parseInterval = GeneratorUtil.parseInterval(constant.getTime().getInterval());
      _builder_2.append(_parseInterval);
      _builder_2.append(")");
  ...
  public static String parseInterval(final String interval) {
    ...
    if (_contains) {
      ...
      String _substring = interval.substring(0, interval.indexOf("d"));
      _builder.append(_substring);
      _builder.append(", ");
      days = _builder.toString();
      pos = interval.indexOf("d");
    }
    boolean _contains_1 = interval.contains("h");
    if (_contains_1) {
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("hours=");
      String _substring_1 = interval.substring(pos, interval.indexOf("h"));
      _builder_1.append(_substring_1);
      _builder_1.append(", ");
      hours = _builder_1.toString();
    ...
    if (_contains_2) {
      ...
      if (_notEquals) {
        StringConcatenation _builder_2 = new StringConcatenation();
        _builder_2.append("minutes=");
        String _substring_2 = interval.substring(pos, interval.indexOf("m"));
        _builder_2.append(_substring_2);
        _builder_2.append(", ");
        minutes = _builder_2.toString();
    ...
    if (_contains_3) {
      ...
      if (_notEquals_1) {
        ...
        _builder_3.append("seconds=");
        String _substring_3 = interval.substring(pos, interval.indexOf("s"));
        _builder_3.append(_substring_3);
        _builder_3.append(", ");
        seconds = _builder_3.toString();
    ...
    if (_contains_4) {
      ...
      _builder_4.append("milliseconds=");
      String _substring_4 = interval.substring(pos, interval.indexOf("ms"));
      _builder_4.append(_substring_4);
      milliseconds = _builder_4.toString();
    }
    final String result = ((((days + hours) + minutes) + seconds) + milliseconds);
    boolean _isEmpty = result.isEmpty();
    boolean _not = (!_isEmpty);
    if (_not) {
      int _length = result.length();
      int _minus_1 = (_length - 2);
      String _substring_5 = result.substring(_minus_1);
      boolean _equals = Objects.equal(_substring_5, ", ");
      if (_equals) {
        int _length_1 = result.length();
        int _minus_2 = (_length_1 - 2);
        return result.substring(0, _minus_2);
      }
    }
    return result;
  }
